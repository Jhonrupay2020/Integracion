			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<input type="hidden" value="<?php echo $row['rolId'];?>" id="rolId<?php echo $user_id;?>">
					...
					<a href="#" class='btn btn-default' title='Borrar usuario' onclick="eliminar('<?= $user_id ?>')"><i class="glyphicon glyphicon-trash"></i> </a></span></td>
