		...
		if (empty($_POST['firstname2'])){
          ...
          )
         {
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
				...
				$user_rolId = mysqli_real_escape_string($con,(strip_tags($_POST["user_rol2"],ENT_QUOTES)));
				
				$user_id=intval($_POST['mod_id']);
					
               
					// write new user's data into database
                    $sql = "UPDATE users SET firstname='".$firstname."', lastname='".$lastname."', user_name='".$user_name."', user_email='".$user_email."', rolId = '".$user_rolId."'
